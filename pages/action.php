...
<body>
    ...
    <nav style= "display: inline" id="main-buttons">
        ...
        <audio id="audio8" src="<?php audioOut(8); ?>" class="css"></audio>
        
        <audio id="audio9" src="<?php audioOut(9); ?>" class="css"></audio>
        
        <audio id="audio10" src="<?php audioOut(10); ?>" class="css"></audio>
        
        
        
<a onclick="playa(audio8)" id="div1" class="buttons">
<p class="cat">
<?php textOut(8); ?>
</p>
</a>
        
<a onclick="playa(audio9)" id="div2" class="buttons">
<p class="cat">
<?php textOut(9); ?>
</p>
</a>
        
<a onclick="playa(audio10)" id="div3" class="buttons">
<p class="cat">
<?php textOut(10); ?>
</p>
</a>
        
<a href="action2.html" id="div4" class="buttons">
<p class="cat">More..</p>
</a>
