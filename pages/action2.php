...
<head id="hea">
    ...
    <link rel="stylesheet" class="css"  href="../css/action.css" type="text/css"/>
...
<body>
    ...
    <nav style= "display: inline" id="main-buttons">
        ...
        <audio id="audio11" src="<?php audioOut(11); ?>" class="css"></audio>
        
        <audio id="audio12" src="<?php audioOut(12); ?>" class="css"></audio>
        
        <audio id="audio13" src="<?php audioOut(13); ?>" class="css"></audio>
        
        <audio id="audio14" src="<?php audioOut(14); ?>" class="css"></audio>
        
        
<a onclick="playa(audio11)" id="div1" class="buttons">
<p class="cat">
<?php textOut(11); ?>
</p>
</a>
        
<a onclick="playa(audio12)" id="div2" class="buttons">
<p class="cat">
<?php textOut(12); ?>
</p>
</a>
        
<a onclick="playa(audio13)" id="div3" class="buttons">
<p class="cat">
<?php textOut(13); ?>
</p>
</a>
        
<a onclick="playa(audio14)" id="div4" class="buttons" style="background-color: #FEFC14">
<p class="cat">
<?php textOut(14); ?>
</p>
</a>
